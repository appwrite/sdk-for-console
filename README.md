...
![Version](https://img.shields.io/badge/api%20version-1.6.5-blue.svg?style=flat-square)
...
```html
<script src="https://cdn.jsdelivr.net/npm/@appwrite.io/console@1.3.0"></script>
```
