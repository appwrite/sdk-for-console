...
**This SDK is compatible with Appwrite server version 1.4.x. For older versions, please check [previous releases](https://github.com/appwrite/sdk-for-console/releases).**
...
```html
<script src="https://cdn.jsdelivr.net/npm/@appwrite.io/console@0.3.0"></script>
```
