...
export class Backups {
     ...
     */
    createArchive(params: { services: string[], resourceId?: string  }): Promise<Models.BackupArchive>;
    /**
     * Create a new archive asynchronously for a project.
     *
    ...
    createArchive(
        paramsOrFirst: { services: string[], resourceId?: string } | string[],
        ...rest: [(string)?]    
    ): Promise<Models.BackupArchive> {
        let params: { services: string[], resourceId?: string };
        
        if ((paramsOrFirst && typeof paramsOrFirst === 'object' && !Array.isArray(paramsOrFirst))) {
            params = (paramsOrFirst || {}) as { services: string[], resourceId?: string };
        } else {
            params = {
                services: paramsOrFirst as string[],
     ...
     * @param {string[]} params.services - Array of services to restore
     ...
     */
    createRestoration(params: { archiveId: string, services: string[], newResourceId?: string, newResourceName?: string  }): Promise<Models.BackupRestoration>;
    /**
     * Create and trigger a new restoration for a backup on a project.
     *
     * @param {string} archiveId - Backup archive ID to restore
     * @param {string[]} services - Array of services to restore
    ...
    createRestoration(
        paramsOrFirst: { archiveId: string, services: string[], newResourceId?: string, newResourceName?: string } | string,
        ...rest: [(string[])?, (string)?, (string)?]    
    ): Promise<Models.BackupRestoration> {
        let params: { archiveId: string, services: string[], newResourceId?: string, newResourceName?: string };
        
        if ((paramsOrFirst && typeof paramsOrFirst === 'object' && !Array.isArray(paramsOrFirst))) {
            params = (paramsOrFirst || {}) as { archiveId: string, services: string[], newResourceId?: string, newResourceName?: string };
        } else {
            params = {
                archiveId: paramsOrFirst as string,
                services: rest[0] as string[],
