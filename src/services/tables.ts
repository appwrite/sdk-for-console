...
export class Tables {
     ...
     */
    listLogs(databaseId: string, tableId: string, queries?: string[]): Promise<Models.LogList> {
        if (typeof databaseId === 'undefined') {
            throw new AppwriteException('Missing required parameter: "databaseId"');
        }
        if (typeof tableId === 'undefined') {
        ...
        const apiPath = '/databases/{databaseId}/tables/{tableId}/logs'.replace('{databaseId}', databaseId).replace('{tableId}', tableId);
        const payload: Payload = {};
        if (typeof queries !== 'undefined') {
            payload['queries'] = queries;
        }
    ...
    listRowLogs(databaseId: string, tableId: string, rowId: string, queries?: string[]): Promise<Models.LogList> {
        ...
        const apiPath = '/databases/{databaseId}/tables/{tableId}/rows/{rowId}/logs'.replace('{databaseId}', databaseId).replace('{tableId}', tableId).replace('{rowId}', rowId);
        const payload: Payload = {};
        if (typeof queries !== 'undefined') {
            payload['queries'] = queries;
        }
     ...
     */
    getUsage(databaseId: string, tableId: string, range?: DatabaseUsageRange): Promise<Models.UsageTable> {
        if (typeof databaseId === 'undefined') {
            throw new AppwriteException('Missing required parameter: "databaseId"');
        }
        if (typeof tableId === 'undefined') {
        ...
        const apiPath = '/databases/{databaseId}/tables/{tableId}/usage'.replace('{databaseId}', databaseId).replace('{tableId}', tableId);
        const payload: Payload = {};
