...
export class Presences {
    ...
    /**
     * Get presence usage metrics and statistics, including the current total of online users and historical online user counts for the selected time range.
     *
     * @param {Range} params.range - Date range.
     * @throws {AppwriteException}
     * @returns {Promise<Models.UsagePresence>}
     */
    getUsage(params?: { range?: Range }): Promise<Models.UsagePresence>;
    /**
     * Get presence usage metrics and statistics, including the current total of online users and historical online user counts for the selected time range.
     *
     ...
     * @deprecated Use the object parameter style method for a better developer experience.
     */
    getUsage(range?: Range): Promise<Models.UsagePresence>;
    getUsage(
        paramsOrFirst?: { range?: Range } | Range    
    ): Promise<Models.UsagePresence> {
