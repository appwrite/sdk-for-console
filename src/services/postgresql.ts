...
export class Postgresql {
     ...
     * @param {string} params.engine - Database engine. Allowed values: postgresql.
     ...
     * @param {string} engine - Database engine. Allowed values: postgresql.
    ...
    get(
        ...
        const apiPath = '/postgresql/{databaseId}'.replace('{databaseId}', encodeURIComponent(String(databaseId)));
        const payload: Payload = {};
        const uri = new URL(this.client.config.endpoint + apiPath);
    ...
    listBackups(
        ...
        const apiPath = '/postgresql/{databaseId}/backups'.replace('{databaseId}', encodeURIComponent(String(databaseId)));
        const payload: Payload = {};
        if (typeof queries !== 'undefined') {
            payload['queries'] = queries;
        }
    ...
    listBackupPolicies(
        ...
        const apiPath = '/postgresql/{databaseId}/backups/policies'.replace('{databaseId}', encodeURIComponent(String(databaseId)));
        const payload: Payload = {};
        if (typeof queries !== 'undefined') {
            payload['queries'] = queries;
        }
    ...
    updateBackupStorage(
        ...
        const apiPath = '/postgresql/{databaseId}/backups/storage'.replace('{databaseId}', encodeURIComponent(String(databaseId)));
        const payload: Payload = {};
        if (typeof provider !== 'undefined') {
    ...
    listBranches(
        ...
        const apiPath = '/postgresql/{databaseId}/branches'.replace('{databaseId}', encodeURIComponent(String(databaseId)));
        const payload: Payload = {};
        const uri = new URL(this.client.config.endpoint + apiPath);
    ...
    createExecution(
        ...
        const apiPath = '/postgresql/{databaseId}/executions'.replace('{databaseId}', encodeURIComponent(String(databaseId)));
        const payload: Payload = {};
        if (typeof sql !== 'undefined') {
            payload['sql'] = sql;
        }
     ...
     */
    listExtensions(params: { databaseId: string }): Promise<Models.DedicatedDatabaseExtensions>;
    /**
     * List installed and available extensions for a PostgreSQL database.
     *
     * @param {string} databaseId - Database ID.
    ...
    listExtensions(
        ...
        const apiPath = '/postgresql/{databaseId}/extensions'.replace('{databaseId}', encodeURIComponent(String(databaseId)));
        const payload: Payload = {};
        const uri = new URL(this.client.config.endpoint + apiPath);
     ...
     * @returns {Promise<Models.DedicatedDatabase>}
     */
    createExtension(params: { databaseId: string, name: string }): Promise<Models.DedicatedDatabase>;
    /**
     * Install a database extension. Only available for PostgreSQL databases. The install runs asynchronously; poll the extensions list endpoint for status.
     *
     * @param {string} databaseId - Database ID.
     ...
     * @returns {Promise<Models.DedicatedDatabase>}
     */
    deleteExtension(params: { databaseId: string, extensionName: string }): Promise<Models.DedicatedDatabase>;
    /**
     * Uninstall a database extension from a PostgreSQL database. The uninstall runs asynchronously; poll the extensions list endpoint for status.
     *
     * @param {string} databaseId - Database ID.
    ...
    deleteExtension(
        ...
        const apiPath = '/postgresql/{databaseId}/extensions/{extensionName}'.replace('{databaseId}', encodeURIComponent(String(databaseId))).replace('{extensionName}', encodeURIComponent(String(extensionName)));
        const payload: Payload = {};
        const uri = new URL(this.client.config.endpoint + apiPath);
    ...
    createFailover(
        ...
        const apiPath = '/postgresql/{databaseId}/failovers'.replace('{databaseId}', encodeURIComponent(String(databaseId)));
        const payload: Payload = {};
    ...
    updateMaintenanceWindow(
        ...
        const apiPath = '/postgresql/{databaseId}/maintenance'.replace('{databaseId}', encodeURIComponent(String(databaseId)));
        const payload: Payload = {};
        if (typeof day !== 'undefined') {
            payload['day'] = day;
        }
    ...
    createMigration(
        ...
        const apiPath = '/postgresql/{databaseId}/migrations'.replace('{databaseId}', encodeURIComponent(String(databaseId)));
        const payload: Payload = {};
        if (typeof targetType !== 'undefined') {
    ...
    getPitrWindows(
        ...
        const apiPath = '/postgresql/{databaseId}/pitr'.replace('{databaseId}', encodeURIComponent(String(databaseId)));
        const payload: Payload = {};
        const uri = new URL(this.client.config.endpoint + apiPath);
    ...
    getPooler(
        ...
        const apiPath = '/postgresql/{databaseId}/pooler'.replace('{databaseId}', encodeURIComponent(String(databaseId)));
        const payload: Payload = {};
        const uri = new URL(this.client.config.endpoint + apiPath);
    ...
    getReplicas(
        ...
        const apiPath = '/postgresql/{databaseId}/replicas'.replace('{databaseId}', encodeURIComponent(String(databaseId)));
        const payload: Payload = {};
        const uri = new URL(this.client.config.endpoint + apiPath);
    ...
    listRestorations(
        ...
        const apiPath = '/postgresql/{databaseId}/restorations'.replace('{databaseId}', encodeURIComponent(String(databaseId)));
        const payload: Payload = {};
        if (typeof status !== 'undefined') {
            payload['status'] = status;
        }
    ...
    getRestoration(
        ...
        const apiPath = '/postgresql/{databaseId}/restorations/{restorationId}'.replace('{databaseId}', encodeURIComponent(String(databaseId))).replace('{restorationId}', encodeURIComponent(String(restorationId)));
        const payload: Payload = {};
        const uri = new URL(this.client.config.endpoint + apiPath);
    ...
    getStatus(
        ...
        const apiPath = '/postgresql/{databaseId}/status'.replace('{databaseId}', encodeURIComponent(String(databaseId)));
        const payload: Payload = {};
        const uri = new URL(this.client.config.endpoint + apiPath);
    ...
    createUpgrade(
        ...
        const apiPath = '/postgresql/{databaseId}/upgrades'.replace('{databaseId}', encodeURIComponent(String(databaseId)));
        const payload: Payload = {};
        if (typeof targetVersion !== 'undefined') {
